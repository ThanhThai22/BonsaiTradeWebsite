      ...
      <div class="row">
        <div class="col-md-3">
          <div class="list-group mt-5">
            ...
            <a href="viewLX.php" class="list-group-item p-3"><span class="" aria-hidden="true"></span> Danh sách LÔ XUẤT </a>
          ...
          <div class="panel panel-default">
            ...
            <tbody>
                <?php foreach ($data as $row) : ?>
                            <tr>
                                <td><?php echo $row['LX_MA']; ?></td>
                                <td><?php echo $row['LX_TEN']; ?></td>
                                <td><?php echo $row['LX_NGAYXUAT']; ?></td>                            
                                <td class="border">   
                                  <form action="xoaLX.php" method="post">
                                    <input type="submit" name="action" value="XÓA" class="btn btn-success mb-3">
                                    <input type="hidden" name="id" value="<?php echo $row['LX_MA']; ?>">
                                  </form>
                                  
                                  <form action="form_edit_LX.php" method="post">
            ...
            <div class="container-fluid"><a href="form_add_LX.php" class="list-group-item bg-success text-white rounded" style="text-align:center; padding: 10px;"><span class="" aria-hidden="true"></span>THÊM LÔ XUẤT</a><br></div>
            </table>
            <?php           
                $servername = "localhost";
                $username = "root";
