...
<div class="col-5" style="margin-left: auto; margin-right: auto;">
        <strong><b>THÊM LÔ XUẤT</b></strong>
            <form class="mt-3" action="themLX.php" method="post" enctype="multipart/form-data">
                <!-- 
                        // LN_MA
                        // LN_TEN
                        // LN_NGAYNHAP -->
            <div class="col-7">
                ...
                <input type="text" name="LX_TEN" class="form-control" required>
            </div>
            <div class="col-7">
                <label for="" class="col-form-label">NGÀY XUẤT LÔ</label>
                <input type="date" class="form-control" name="LX_NGAYXUAT" required>
            </div>
