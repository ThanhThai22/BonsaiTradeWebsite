...
<body> 
   ...
   <section id="main">
    ...
    $id = $_POST['id'];
    $sql = "select * from lonhaps where LN_MA = '".$id."' ";
    $res = $conn->query($sql);
    $row = $res->fetch_assoc();
  ?>
...
<strong><b>SỬA LÔ NHẬP</b></strong>
            <form class="mt-3" action="suaLN.php" method="post">
                <div class="col-7">
                    ID: <input type="text" name="id" value="<?php echo $row['LN_MA'] ?>" >
                </div>
                <div class="col-7">
                    <label for="" class="">TÊN LÔ NHẬP</label>
                    <!-- <input type="text" class="form-control" name=""> -->
                    <input type="text" name="LN_TEN" id="NV_HOTEN" class="form-control" required value="<?php echo $row['LN_TEN'] ?>">
                </div>
                <div class="col-7">
                    <label for="" class="col-form-label">NGÀY NHẬP LÔ</label>
                    <input type="date" class="form-control" name="LN_NGAYNHAP" required value="<?php echo $row['LN_NGAYNHAP'] ?>">
                </div>
