      ...
      <div class="row">
        <div class="col-md-3">
          <div class="list-group mt-5">
            ...
            <a href="viewLN.php" class="list-group-item p-3"><span class="" aria-hidden="true"></span> Danh sách LÔ NHẬP </a>
        ...
        <div class="col-md-9">
          <div class="panel panel-default">
            <div class="panel-heading main-color-bg">
              <h3 class="panel-title ">LÔ NHẬP</h3>
            </div>
            </div>
            <br>
            ...
            <tbody>
                <?php foreach ($data as $row) : ?>
                            <tr>
                                <td><?php echo $row['LN_MA']; ?></td>
                                <td><?php echo $row['LN_TEN']; ?></td>
                                <td><?php echo $row['LN_NGAYNHAP']; ?></td>                            
                                <td class="border">   
                                  <form action="xoaLN.php" method="post">
                                    <input type="submit" name="action" value="XÓA" class="btn btn-success mb-3">
                                    <input type="hidden" name="id" value="<?php echo $row['LN_MA']; ?>">
                                  </form>
                                  
                                  <form action="form_edit_LN.php" method="post">
            ...
            <div class="container-fluid"><a href="form_add_LN.php" class="list-group-item bg-success text-white rounded" style="text-align:center; padding: 10px;"><span class="" aria-hidden="true"></span>THÊM LÔ NHẬP</a><br></div>
            </table>
            <?php           
                $servername = "localhost";
                $username = "root";
