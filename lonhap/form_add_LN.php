...
<strong><b>THÊM LÔ NHẬP</b></strong>
            <form class="mt-3" action="themLN.php" method="post" enctype="multipart/form-data">
                <!-- 
                        // LN_MA
                        // LN_TEN
                        // LN_NGAYNHAP -->
            <div class="col-7">
                ...
                <input type="text" name="LN_TEN" id="NV_HOTEN" class="form-control" required>
            </div>
            <div class="col-7">
                <label for="" class="col-form-label">NGÀY NHẬP LÔ</label>
                <input type="date" class="form-control" name="LN_NGAYNHAP" required>
            </div>
