...
<body> 
   ...
   <main>
           <div id="wrapper">
               <div class="headline">
                   <h3 class="sp"> Cây cảnh để bàn </h3>
               </div>
               <ul class="products">
                       <li>
                           <div class="products-item">
                               <div class="products-top">
                                   <a class="products-thumb">
                                       <img class="picturesize" src="./picCay/cay1.png" alt="">
                                   </a>  
                                   <a class="buy-now" href="giohang.html">Mua Ngay</a> 
                               </div>
                               <div class="products-info">
                                   <a  class="products-name">Cây asp</a>
                       ...
                       <li>
                           <div class="products-item">
                               <div class="products-top">
                                   <a href="" class="products-thumb">
                                       <img class="picturesize" src="./picCay/cay2.png" alt="">
                                   </a>  
                                   <a class="buy-now" href="giohang.html">Mua Ngay</a>  
                               </div>
                               <div class="products-info">
                                   <a href="" class="products-name">Cây lưỡi hổ</a>
                                   <div href="" class="products-price">Giá: 300,000 VNĐ</div>
                                   <div class="products-add">
                                       <a class="count">Số lượng:</a>
                                       <input aria-label="quantity" class="input-qty" max="50" min="0" name="" type="number" value="">
                           ...
                           <div class="products-item">
                               <div class="products-top">
                                   <a href="" class="products-thumb">
                                       <img class="picturesize" src="./picCay/cay3.png" alt="">
                                   </a>   
                                   <a class="buy-now" href="giohang.html">Mua Ngay</a> 
                               </div>
                               <div class="products-info">
                                   <a href="" class="products-name">Cây jbjs</a>
                                   <div href="" class="products-price">Giá: 300,000 VNĐ</div>
                                   <div class="products-add">
                                       <a class="count">Số lượng:</a>
                                       <input aria-label="quantity" class="input-qty" max="50" min="0" name="" type="number" value="">
                           ...
                           <div class="products-item">
                               <div class="products-top">
                                   <a href="" class="products-thumb">
                                       <img class="picturesize" src="./picCay/cay4.png" alt="">
                                   </a>   
                                   <a class="buy-now" href="giohang.html">Mua Ngay</a> 
                               </div>
                               <div class="products-info">
                                   <a href="" class="products-name">Cây tỉ phú</a>
                                   <div href="" class="products-price">Giá: 300,000 VNĐ</div>
                                   <div class="products-add">
                                       <a class="count">Số lượng:</a>
                                       <input aria-label="quantity" class="input-qty" max="50" min="0" name="" type="number" value="">
                           ...
                           <div class="products-item">
                               <div class="products-top">
                                   <a href="" class="products-thumb">
                                       <img class="picturesize" src="./picCay/cay5.png" alt="">
                                   </a>  
                                   <a class="buy-now" href="giohang.html">Mua Ngay</a>  
                               </div>
                               <div class="products-info">
                                   <a href="" class="products-name">Cây cọ mini</a>
                                   <div href="" class="products-price">Giá: 300,000 VNĐ</div>
                                   <div class="products-add">
                                       <a class="count">Số lượng:</a>
                                       <input aria-label="quantity" class="input-qty" max="50" min="0" name="" type="number" value="">
                           ...
                           <div class="products-item">
                               <div class="products-top">
                                   <a href="" class="products-thumb">
                                       <img class="picturesize" src="./picCay/Cay6.png" alt="">
                                   </a>   
                                   <a class="buy-now" href="giohang.html">Mua Ngay</a> 
                               </div>
                               <div class="products-info">
                                   <a href="" class="products-name">Hoa Ly -Tình Yêu Thuỷ Chung</a>
                                   <div href="" class="products-price">Giá: 300,000 VNĐ</div>
                                   <div class="products-add">
                                       <a class="count">Số lượng:</a>
                                       <input aria-label="quantity" class="input-qty" max="50" min="0" name="" type="number" value="">
