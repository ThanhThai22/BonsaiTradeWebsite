...
<div class="col-5" style="margin-left: auto; margin-right: auto;">
            <strong><b>SỬA ĐƠN HÀNG</b></strong>
            <form class="mt-3" action="suaDH.php" method="post">
                <div class="col-7">
                    ID: <input type="text" name="id" value="<?php echo $row['DH_ID'] ?>" >
                </div>
                <BR>
                <div class="col-7 mb-3">
                    <label for="" class="">TRẠNG THÁI ĐƠN HẦNG</label>
                    <!-- <input type="text" class="form-control" name=""> -->
                    <select name="TTDH_ID" class="form-control">
                        <?php
                ...
                <input type="text" class="form-control" name="DH_NGAYTAO" required value="<?php echo $row['DH_NGAYTAO']; ?>">
            </div>
