   ...
   <div class="row">
     ...
     <div class="list-group mt-5">
          ...
          <?php           
                ...
                $sql = " SELECT * FROM donhang a, khachhangs b, trangthaidonhangs c where a.kh_id=b.kh_id and a.ttdh_id=c.ttdh_id";    
                ...
                while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
                    $data[] = array(
                        'DH_ID' => $row['DH_ID'], 
                        'TTDH_ID' => $row['TTDH_TEN'],
                        'KH_TEN' => $row['KH_HOTEN'],
                        'DH_NGAYTAO' => $row['DH_NGAYTAO']
                    );
                    $rowNum++;
                }
            ?>
        ...
        <div class="col-md-9">
          <div class="panel panel-default">
            ...
            <tbody>
                <?php foreach ($data as $row) : ?>
                            <tr>
                                ...
                                <td><?php echo $row['TTDH_ID']; ?></td>
                                <td><?php echo $row['KH_TEN']; ?></td> 
                                <td><?php echo $row['DH_NGAYTAO']; ?></td>                                
                                <td class="border">   
                                  <form action="xoaDH.php" method="post">
                                    <input type="submit" name="action" value="XÓA" class="btn btn-success mb-3">
                                    <input type="hidden" name="id" value="<?php echo $row['DH_ID']; ?>">
                                  </form>
                                  
                                  <form action="form_edit_DH.php" method="post">
            ...
            <div class="container-fluid"><a href="form_add_DH.php" class="list-group-item bg-success text-white rounded" style="text-align:center; padding: 10px;"><span class="" aria-hidden="true"></span>THÊM ĐƠN HÀNG</a><br></div>
            </table>
            <?php           
                $servername = "localhost";
                $username = "root";
