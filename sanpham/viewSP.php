      ...
      <div class="row">
        <div class="col-md-3">
          <div class="list-group mt-5">
            ...
            <a href="#" class="list-group-item p-3"><span class="" aria-hidden="true"></span> DANH SÁCH SẢN PHẨM </a>  
        ...
        <?php           
                ...
                $sql = " SELECT * FROM sanphams a, nhanviens b, loaisanphams c where a.nv_id=b.nv_id and a.lsp_id=c.lsp_id";    
            ...
            <tbody>
                <?php foreach ($data as $row) : ?>
                            <tr>
                                ...
                                <td>
                                  <img src="img/<?php echo $row['SP_LINKANH']; ?>" style="width: 100px;">
                                </td>
                                ...
                                <td class="border">   
                                  ...
                                  <form action="form_edit_SP.php" method="post">
...
<div class="container-fluid"><a href="form_add_SP.php" class="list-group-item bg-success text-white rounded" style="text-align:center; padding: 10px;"><span class="" aria-hidden="true"></span>THÊM SẢN PHẨM</a><br></div>
            </table>
            <?php           
                $servername = "localhost";
                $username = "root";
