...
<!-- <div style="margin-left: auto; margin-right: auto;">
    ...
    <strong><b>THÊM SẢN PHẨM</b></strong>
        <form class="mt-4" action="themSP.php" method="post" enctype="multipart/form-data">
        <div class="col-7">
        ...
        <div class="col-7">
            ...
            <input type="text" class="form-control" name="sp_ten" required>
        </div>
        <div class="col-7">
        ...
        <div class="col-7">
            ...
            <input type="text" name="sp_linkanh" class="form-control">
        </div>
        <div class="col-7">
            <label for="" class="col-form-label">ĐƠN GIÁ</label>
            <input type="text" class="form-control" name="sp_dongia" required>
        </div>
        ...
        <div class="col-7 mt-3">
            <button name="sbm" class="btn btn-success" type="submit">Lưu</button><br>
        </div>
