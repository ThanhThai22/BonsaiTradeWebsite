...
<body> 
   ...
   <section id="main">
    ...
    $sql_sp = "select * from loaisanphams";
...
<div class="col-5" style="margin-left: auto; margin-right: auto;">
            <strong><b>THÊM DỊCH VỤ</b></strong>
            <form class="mt-3" action="themDV.php" method="post" enctype="multipart/form-data">
                <!-- 
                        // LN_MA
                        // LN_TEN
                        // LN_NGAYNHAP -->
            <div class="col-7">
                ...
                <input type="text" name="DV_TEN" class="form-control" required>
            </div>
            <div class="col-7">
                <label for="" class="col-form-label">MÔ TẢ</label>
                <input type="text" class="form-control" name="DV_MOTA" required>
            </div>
            <div class="col-7">
                <label for="" class="col-form-label">ĐƠN GIÁ</label>
                <input type="text" class="form-control" name="DV_DONGIA" required>
            </div>
