  ...
  <body>
    <header id="header">
      <nav class=" navbar navbar-expand-sm bg ">
          <a href="trangchu.php" class="navbar-brand fs-3 ms-5 ">Flowers Nature</a>
          ...
          <div class="contain">
            ...
            <form method="post" action="login.php">
                ...
                <div class="fogotpass">
                  ...
                  <input type="submit" value="Đăng nhập" class="sub" style="margin-bottom: 15px;">
                  <div class="signup_link">Chưa có tài khoản <a href="dangki.html">Đăng kí</a></div>
            </form>
          </div>
        </div>
        <div class="gap-element clearfix" style="display:block; height:auto; padding-top:30px "></div> 
